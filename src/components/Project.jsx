...
import ezyResume from "../assects/ezyResume.png";
  ...
  const projects = [
    {
      id: 1,
      src: ezyResume,
      link: 'https://ezy-resume.netlify.app/',
      },
  ...
  <div  className='grid sm:grid-col-2 md:grid-cols-2 gap-8 px-12 sm:px-0'>
        {
          ...
          <div key={id} className='shadow-md shadow-gray-600 rounded-lg '>
            <img src={ src } alt="" srcset="" className=' sm:h-[250px] lg:rounded-md duration-200 hover:scale-105 h-[150px] w-full object-cover  ' />
